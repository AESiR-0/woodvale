...
export default function AboutPage() {
  const restaurant = {
    ...
    mission: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, nihil? Corporis autem rem maiores vel modi tenetur accusamus laudantium eveniet repellendus suscipit dolor, sint consectetur. Fuga corporis inventore rem neque quidem quisquam dignissimos minus dicta, impedit ullam facere unde nemo?",
  };

  return (
    <div className="min-h-screen bg-[var(--leaf)]">
      <Navbar />
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="relative h-64 mb-8">
          <div className="absolute bottom-4 bg-white bg-opacity-75 p-4 rounded">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto eveniet, deserunt dolorum tempore ducimus nihil asperiores explicabo itaque nesciunt sequi ipsa molestias rem reprehenderit dolores harum? In voluptatibus eum ratione odio, unde recusandae praesentium excepturi tempora. Eius quisquam porro, dolorem tempora eligendi magni asperiores veritatis perferendis ipsam, sequi excepturi esse.
            </p>
          </CardContent>
        </Card>
      </main>

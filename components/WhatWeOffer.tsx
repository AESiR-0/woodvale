...
export default function ServicesSection() {
  ...
  return (
    <section ref={sectionRef} className="bg-[var(--leaf)]">
      <div
        className="bg-gradient-radial p-18 from-transparent via-transparent to-black/20"
        style={{
          background:
      ...
      >
        <div className="container mx-auto px-6 ">
          <div className="flex flex-col lg:flex-row lg:items-start lg:gap-16">
            {/* Section Header */}
            <div className="services-header mb-12 lg:mb-0 lg:w-2/5 lg:sticky lg:top-32">
              <p className="text-white/80 text-sm uppercase tracking-wider mb-3">
                What we offer
              </p>
              <h2 className="font-sans text-4xl lg:text-5xl font-bold text-white leading-tight mb-4">
                Our Great Services
              </h2>
            ...
            <div className="flex flex-col gap-8 lg:w-3/5">
              ...
              <div className="service-card group cursor-pointer">
                <div className="relative h-80 lg:h-96 rounded-lg overflow-hidden mb-6 shadow-2xl">
                  <Image
                ...
                <h3 className="font-sans text-xl lg:text-2xl font-semibold text-white group-hover:text-[#a8d5ba] transition-all duration-300 text-center">
                  Fine Dining Experience
                </h3>
              </div>

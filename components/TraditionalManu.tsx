      ...
      <div className="container mx-auto px-6 pt-32 pb-20 bg-[#E6E8D9]">
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                description:
                  "smoked ham, poached eggs, hollandaise, hashed potatoes",
                price: 18,
              },
              {
                name: "Salmon Benny",
                description:
                  "smoked salmon, poached eggs, spinach, hollandaise, potatoes",
                price: 24,
              },
              {
                name: "French Toast",
                description:
                  "cinnamon loaf, wildberry compote, lemon mascarpone, maple syrup, fruit",
                price: 17,
              },
              {
                name: "Breakfast Burrito",
                description:
                  "ham or bacon, wild mushrooms, tomatoes, scrambled egg, spinach, smashed potatoes",
                price: 17,
              },
              {
                name: "Chicken & Waffles",
                description:
                  "maple glazed crispy chicken, belgian waffles, pickled onions, arugula, salted caramel",
                price: 22,
              },
              {
                name: "Woodvale Classic",
                description:
                  "choice of bacon or sausage, eggs, hashed potatoes, sourdough toast",
                price: 16,
              },
              {
                name: "Breakfast Hash",
                description:
                  "braised short rib, hashed potatoes, poached eggs, pickled onion, hollandaise, crispy tortilla strips",
                price: 18,
              },
            ].map((dish, i) => (
        ...
        <section className="mb-20">
          ...
          <div className="mb-16">
            ...
            {/* Gin List */}
            <div className="grid md:grid-cols-2 gap-6 lg:text-center text-[#071d18]/80 mb-8">
              {[
                {
                  name: "Park Alpine Dry Gin",
                  region: "Canada",
                  notes: "juniper, citrus, spruce pine, herbs",
                },
                {
                  name: "Bulldog",
                  region: "UK",
                  notes: "floral, exotic fruit, citrus, juniper",
                },
                {
                  name: "Dillon's",
                  region: "Canada",
                  notes: "juniper, unfiltered, complex",
                },
                {
                  name: "Gin Mare",
                  region: "Spain",
                  notes: "juniper, olives, rosemary, thyme",
                },
                {
                  name: "Empress",
                  region: "Canada",
                  notes: "bold juniper, citrus, floral",
                },
                {
                ...
                },
                {
                  name: "Brockman's",
                  region: "UK",
                  notes: "coriander, blackberry, valencia orange",
                },
                {
                  name: "Strathcona Spirits Badland",
                  region: "Canada",
                  notes: "juniper, seaberry, dry",
                },
                {
                  name: "Hayman's Sloe Gin",
                  region: "UK",
                  notes: "almond, frangipane, and berries",
                },
                {
                  name: "Hendrick's",
                  region: "Scotland",
                  notes: "cucumber, rose, honeyed citrus, juniper",
                },
                {
                ...
                },
                {
                  name: "The Botanist",
                  region: "Scotland",
                  notes: "orris root, cassia bark, coriander, and juniper",
                },
                {
                  name: "Aviation",
                  region: "USA",
                ...
                },
                {
                  name: "Citadelle",
                  region: "France",
                  notes: "liquorice, coriander, lemon, almond, juniper, oak",
                },
                {
                  name: "Boodles",
                  region: "UK",
                  notes: "cassia, caraway, rosemary, sage, juniper",
                },
                {
                  name: "Noteworthy",
                  region: "Canada",
                  notes: "orange, botanicals, tang crystals",
                },
                {
                  name: "Lind & Lime",
                  region: "Scotland",
                ...
                },
                {
                  name: "Blossom Peach",
                  region: "Spain",
                  notes: "peach, juniper, citrus",
                },
                {
                  name: "Romeo's X",
                  region: "Canada",
                  notes: "watermelon, lavender, cucumber",
                },
                {
                  name: "Sorgin",
                  region: "France",
                  notes:
                    "sauvignon blanc grapes, juniper, violet, broom flower, grapefruit",
                },
                {
                  name: "Tanqueray 10",
                  region: "UK",
                  notes: "juniper, citrus peel, grapefruit, chamomile",
                },
                {
                  name: "Caorunn",
                  region: "UK",
                ...
                },
                {
                  name: "Dingle",
                  region: "Canada",
                  notes: "berry, fuchsia, bog myrtle",
                },
                {
                  name: "Roku",
                  region: "Japan",
                ...
                },
                {
                  name: "Bathtub",
                  region: "UK",
                  notes: "grapefruit, rosemary, herbal",
                },
                {
                  name: "Malfy Arancia",
                  region: "Italy",
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:text-center text-[#071d18]/80">
              <div>
                <h4 className="text-xl text-center font-semibold text-[var(--mint)] mb-4">
                  Tonics
                </h4>
        ...
        <section className="mb-20">
          ...
          <div className="mb-16">
            ...
            {[
              ...
              {
                name: "Pillitteri Gewurztraminer / Riesling",
                region: "Canada",
                price6: 13,
                price9: 18,
                bottle: 52,
              ...
              {
                name: "Guillaume Vrignaud Chablis",
                region: "France",
                price6: "-",
                price9: "-",
                bottle: 99,
          ...
          <div className="mb-16">
            ...
            {[
              {
                name: "Angove Cabernet Sauvignon",
                region: "Australia",
                price6: 13,
                price9: 18,
                bottle: 52,
              ...
              {
                name: "Sequoia Grove Cabernet Sauvignon",
                region: "California",
                price6: "-",
                price9: "-",
                bottle: 189,
              ...
              >
                <div>
                  <h5 className="font-lore font-light text-3xl">
                    {wine?.name?.split(/([&/])/).map((part, i) =>
                      part === "&" || part === "/" ? (
                        <span key={i} className="font-lora">
                          {" "}
                          {part}{" "}
                        </span>
                      ) : (
